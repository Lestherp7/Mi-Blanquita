...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Para mi chelita bella :\n\nGracias por apoyarme y ayudarme a sentir mejor todo este tiempo a pesar de la distancia. quiero que sepa que usted la persona con la que deseo quedarme el resto de mi vida.\n\n voy estar con usted y para usted siempre princesa, la apoyare  pase lo que pase .\n\nTe amo más de lo que las palabras pueden expresar mi blanquita hermosa.`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con amor,su Chocomilk";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2024-07-29T00:00:00'); 
  ...
  function update() {
    ...
    container.innerHTML =
      `Llevamos juntos: <b>${389}</b> días<br>` +
